...
<body>
    ...
    <section class="wrapper">
        <div class="loginPage" style="background-image: url(/assets/c20a81c4/img/bgwhy.png);">
            <div class="loginForm">
                <form id="request-password-reset-form" action="{{route('forgot_submit')}}" method="post">
                   {{ csrf_field() }}
                    <div class="formBl">
                        ...
                        <div class="inputList">
                            ...
                            <div class="inputLine field-passwordresetrequestform-email required">
                                <input type="text" id="passwordresetrequestform-email" class="form-control"
                                    ...
                                    aria-required="true"><span class="iconBl icon-mail-3"></span>
                            </div>
                        ...
                        <div class="form-group field-check3">
                            ...
                            onclick="document.getElementById('check3').value = 'nospam';">Send</button>
                </form>
                <div class="links">
