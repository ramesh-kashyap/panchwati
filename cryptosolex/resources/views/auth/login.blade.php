                    ...
                    <div class="formBl">
                        ...
                        <div class="inputList">
                            ...
                            <div class="inputLine field-loginform-username required">
                                <input type="text" id="loginform-username" class="form-control" name="username"
                                    placeholder="username" aria-required="true"><span
                                    class="iconBl icon-user-12--"></span>
                            </div>
                            <div class="inputLine field-loginform-password required">
                                <input type="password" id="loginform-password" class="form-control" name="password"
                                    placeholder="Password" aria-required="true"><span
                                    class="icViewPass iconBl icon-lock"></span>
                            </div>

                            <div class="chekBl field-agreeReg">
                                <input type="hidden" name="LoginForm[rememberMe]" value="0"><input type="checkbox"
                                    id="agreeReg" name="LoginForm[rememberMe]" value="1" checked checked> <label
                                    class="css-label" for="agreeReg">Remember me</label>
                        ...
                        <div class="form-group field-check2">
                            <input type="hidden" id="check2" class="form-control" name="LoginForm[check]"
                                value="">
                        </div> <button class="btn btnBlue" style="margin-top:-5px; margin-bottom:30px"
