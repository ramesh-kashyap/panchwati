                        ...
                        <div class="tab-content" id="pills-tabContent2">
                            ...
                            <div class="tab-pane fade show active" id="price" role="tabpanel" tabindex="0">
                                <div class="recent-contact pb-2 pt-3">
                                        ...
                                        <form action="{{ route('user.dailyIncentive') }}" method="GET" style="    width: 100%;">
                                        <div class="row">
                                            <div class="col-xl-4">
                                            ...
                                            <div class="col-3">
                                                <div class="form-group mb-3">
                                                    <a href="{{ route('user.dailyIncentive') }}" style="font-size: 12px; padding-left: 18px;"
                                                        name="reset"
                                                        class="btn btn-outline-theme btn-lg d-block w-100 btn-primary"
                                                        value="Reset">Reset</a>
                                                </div>
