            ...
            <div class="col">
                <div class="inputLine">
                    ...
                    <select name="type" class="selectricBl" onchange="location = this.value;">
                        ...
                        <option <?php ($page=="level-income")?'selected':'';?> value="{{route('user.left-team')}}" >Left Team</option>
                        <option <?php ($page=="matching-bonus")?'selected':'';?> value="{{route('user.right-team')}}">Right Team</option>
                        <option  <?php ($page=="reward-bonus")?'selected':'';?> value="{{route('user.tree-view')}}">Tree View</option>
                ...
                <div class="slideBlock branch1">
                    <div class="slideTitle" onclick="return clickRef(2, 1074);" id="el1074" data-level="1">
                        <div class="line">
                            ...
                            <span class="txt"> <span class="mobileTiTPart">Package </span> {{currency()}} {{$value->investment->sum('amount')}}</span>
